...
The linking table needs to be declared first :
  ...
  $schema->Table(qw/link_table link_table prim_key1 prim_key2/);

  $schema->Association([qw/table1     role1       0..1/],
                       [qw/link_table link_table  *   /]);
...
Scalar values returned by L<_singleInsert()|/"_singleInsert"> 
are collected into
...
find all dependent composite parts (this is the job of the client
