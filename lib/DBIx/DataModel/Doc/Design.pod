...
a future release C<DBIx::DataModel> :
  ...
  - could probably dispense with createStatement method (replace by
  ...
  - -resultAs => 'hashref' could be similar to DBI::selectall_hashref ...
      .. but need to decide what to put in hash keys in case of joins