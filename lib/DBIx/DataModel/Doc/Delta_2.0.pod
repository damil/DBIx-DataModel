...
DBIx::DataModel::Doc::Delta_2.0 - Differences introduced in version 2.0
...
For older changes, see also L<DBIx::DataModel::Doc::Delta_1.0>.
...
C<$dbh>, through the L<DBIx::DataModel::Schema/localize_state> 
and L<DBIx::DataModel::Schema/do_transaction methods>. However, 
...
an helps to discover errors sooner.

=head2 Extented usage for C<update()> and C<delete()>
...
The former C<DBIx::DataModel::View> class is deprecated; it is now
